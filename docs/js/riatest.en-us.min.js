...
'\n            </ol>\n            <div class="notes" style="display: none">'+L(a.C)+"</div>\n        "};function O(a){w.call(this,"section","page edit-question");this.a=a;a=a.o;20<a.length&&(a=a.substr(17)+"…");this.title="Edit Question: "+a;this.K=0;this.D=null}n(O,w);
...
function X(a,b,c){a.A&&(a.A.remove(),a.A=null);b=new b(c);b.display(a.b);a.A=b;document.title=b.title||"Practice Exam";return b}g.W=function(){X(this,J,this.g)};g.O=function(a,b){b=parseInt(b,10)||5;a=qa(this.g.f).slice(0,b);X(this,M,a)};g.U=function(){X(this,T,this.g)};function Y(a){localStorage.setItem("questionStore",JSON.stringify(B(a.g)))}g.V=function(a,b){var c=this;(b=this.g.f[parseInt(b,10)-1])?X(this,O,b).D=function(){Y(c);location.hash="#edit"}:this.N(a)};
