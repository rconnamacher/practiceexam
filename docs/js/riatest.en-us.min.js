/*Practice Test 0.0.2, (c) 2018 Richard Connamacher. All Rights Reserved.*/ (function(){'use strict';var g,aa="function"==typeof Object.create?Object.create:function(a){function b(){}b.prototype=a;return new b},h;if("function"==typeof Object.setPrototypeOf)h=Object.setPrototypeOf;else{var k;a:{var ba={S:!0},l={};try{l.__proto__=ba;k=l.S;break a}catch(a){}k=!1}h=k?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var m=h;
function q(a,b){a.prototype=aa(b.prototype);a.prototype.constructor=a;if(m)m(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.ea=b.prototype}var ca="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},r="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this;
...
function la(a,b){function c(a){return function(){return this.get(a)}}function d(a){return function(b){return this.set(a,b)}}if(!(a.prototype instanceof C))throw new TypeError("Not a Model: "+a.name);var e={},f={},n;for(n in b){var p=b[n],A=p[0];p=p[1];if(!A)throw new TypeError("Field name is missing");if(!p)throw new TypeError("Field definition is missing");e[A]=p;f[n]={enumerable:!0,configurable:!0,get:c(A),set:d(A)}}ka(a,e);Object.defineProperties(a.prototype,f)};function I(a){C.call(this,a)}q(I,C);la(I,{o:["question",new G("string",void 0)],s:["answer",new G("string",void 0)],h:["incorrectAnswers",new H("string",void 0)]});function J(a){C.call(this,a)}q(J,C);la(J,{c:["questions",new H(I,void 0)]});function K(a){x.call(this,"section","page homepage");this.a=a}q(K,x);K.prototype.f=function(){return'\n            <header>\n                <h2>Ria Practice Exam</h2>\n            </header>\n            <main>\n                <p><a class="button button-take-test'+(this.a.c.length?"":" disabled")+'" href="#taketest/5">Take Exam</a>\n                    ( <input type="number" class="num-questions" value="5"> Questions)</p>\n                <p><a class="button" href="#edit">Edit Test Bank</a></p>\n            </main>\n        '};
K.prototype.i=function(){var a=this.querySelector("input.num-questions"),b=this.querySelector("a.button-take-test");a.addEventListener("input",function(){b.href="#taketest/"+a.value})};var L=1;function ma(a){for(var b=[],c=0,d=a.length;c<d;c++)b.splice(Math.floor(Math.random()*(c+1)),0,a[c]);return b};function na(a){return a.replace(/[&<>"']/g,function(a){return{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}[a]})};function M(a){x.call(this,"section","page take-test");this.c=a;this.K=[]}q(M,x);M.prototype.f=function(){return"\n            <header><h2>"+("Sample Test: "+this.c.length+" Questions")+'</h2></header>\n            <main class="test-questions"></main>\n            <footer>\n                <a class="button button-grade-test">Grade Test</a>\n                <span class="test-results"></span>\n            </footer>\n        '};
...
function N(a,b){x.call(this,"section","question");this.a=a;this.index=b}q(N,x);
N.prototype.f=function(){var a=this.a,b=ma(a.h.concat([a.s])),c="question-"+this.index,d=0,e;return'\n            <h3 class="question '+c+'">'+(this.index+1)+". "+a.o+'</h3>\n            <ol class="answers" type="A">\n                '+b.map(function(a){return e=c+"-answer-"+ ++d,'\n                        <li>\n                            <input type="radio" name="'+c+'" value="'+na(a)+'" id="'+e+'"\n                            ><label for="'+e+'">'+na(a)+"</label>\n                        </li>\n                    "}).join("")+
"\n            </ol>\n        "};function O(a){x.call(this,"section","page edit-question");this.a=a;a=a.o;20<a.length&&(a=a.substr("17\u2026"));this.title="Edit Question: "+a;this.J=0;this.C=null}q(O,x);
...
g.m=function(){this.v()};g.v=function(){this.a.unobserve("questions",this)};g.da=function(){var a=this,b=new S(this.a);y(this,b);b.onclose=function(){z(a,b)}};g.$=function(){var a=this,b=new R(this.a);y(this,b);b.onclose=function(){z(a,b)}};function U(a,b){x.call(this,"tr","question");this.a=a;this.index=b}q(U,x);U.prototype.f=function(){return'\n            <th class="number">'+(this.index+1)+'</th>\n            <td class="question"></td>\n            <td class="answer" title="Answer: "></td>\n            <td class="incorrect-answers" title="Incorrect Answers: "></td>\n        '};
U.prototype.i=function(){function a(a){p.innerHTML="";for(var b=0,c=a.length;b<c;b++){var d=document.createElement("div");d.textContent=a[b];b<c-1&&(d.textContent+=",");p.appendChild(d)}}function b(a){n.textContent=a}function c(a){f.textContent=a}var d=this,e=this.a;this.v();this.b.addEventListener("click",function(){location.hash="#edit/"+(d.index+1)});var f=this.querySelector("td.question"),n=this.querySelector("td.answer"),p=this.querySelector("td.incorrect-answers");c(e.o);b(e.s);a(e.h);e.observe("question",
this,c);e.observe("answer",this,b);e.observe("incorrectAnswers",this,a)};U.prototype.m=function(){this.v()};U.prototype.v=function(){var a=this.a;a.unobserve("question",this);a.unobserve("answer",this);a.unobserve("incorrectAnswers",this)};function V(a){var b=this;this.R=a;this.F=function(){a:{var a=location.hash.substr(1),d,e=w(b.R);for(d=e.next();!d.done;d=e.next()){var f=d.value;if(d=f.pattern.exec(a)){f.j.apply(null,d);break a}}console.error("Unable to find handler for route "+a,b.R)}}}V.prototype.start=function(){window.addEventListener("hashchange",this.F);this.F()};V.prototype.stop=function(){window.removeEventListener("hashchange",this.F)};var oa={questions:[{question:"What is the meaning of Life, the Universe, and Everything?",answer:"Nobody knows because the Earth was blown up",incorrectAnswers:["42","Vogon poetry","Don\u2019t panic"]}]};function W(){x.call(this,"div","app");this.g=this.A=null;this.ca=new V([{pattern:/^$/,j:this.V.bind(this)},{pattern:/^taketest$/,j:this.N.bind(this)},{pattern:/^taketest\/(\d+)$/,j:this.N.bind(this)},{pattern:/^edit$/,j:this.T.bind(this)},{pattern:/^edit\/(\d+)$/,j:this.U.bind(this)},{pattern:/^edit\/new$/,j:this.W.bind(this)},{pattern:/.*/,j:this.M.bind(this)}])}q(W,x);g=W.prototype;g.f=function(){return""};
