...
this,c);e.observe("answer",this,b);e.observe("incorrectAnswers",this,a)};U.prototype.m=function(){this.v()};U.prototype.v=function(){var a=this.a;a.unobserve("question",this);a.unobserve("answer",this);a.unobserve("incorrectAnswers",this)};function V(a){var b=this;this.R=a;this.F=function(){a:{var a=location.hash.substr(1),d,e=w(b.R);for(d=e.next();!d.done;d=e.next()){var f=d.value;if(d=f.pattern.exec(a)){f.j.apply(null,d);break a}}console.error("Unable to find handler for route "+a,b.R)}}}V.prototype.start=function(){window.addEventListener("hashchange",this.F);this.F()};V.prototype.stop=function(){window.removeEventListener("hashchange",this.F)};function W(){x.call(this,"div","app");this.g=this.A=null;this.ca=new V([{pattern:/^$/,j:this.V.bind(this)},{pattern:/^taketest$/,j:this.N.bind(this)},{pattern:/^taketest\/(\d+)$/,j:this.N.bind(this)},{pattern:/^edit$/,j:this.T.bind(this)},{pattern:/^edit\/(\d+)$/,j:this.U.bind(this)},{pattern:/^edit\/new$/,j:this.W.bind(this)},{pattern:/.*/,j:this.M.bind(this)}])}q(W,x);g=W.prototype;g.f=function(){return""};
